        ...
        $(function () {
            ...
            $('#product_id').on('change', function(){
                $.ajax({
                    ...
                    success:    function (result) {
                        ...
                        $('#product_price').text(parseFloat((result.buying_price) ? parseFloat(result.buying_price).toFixed(2) : '0.00');
            ...
            $('body').on('keyup', '.in-product-price', function(e){
                ...
                var id = $(this).closest('tr').attr('id');
                    $.getJSON("{{ url('products') }}/modify/updateBuyingPrice?id=" + id + '&price=' + $(this).val(), function (result) {
                        var total = 0;
                        $('.product-overview tbody tr').each(function() {
                            total += parseInt($(this).find('td:eq(6) input').val());
                        });
