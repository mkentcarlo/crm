				...
				<div class="panel-wrapper collapse in">
					<div class="panel-body">
						...
						<div class="col-md-2 pt-35">
							<div class="btn-group">
								<a class="btn btn-default btn-outline export-invoice-csv" role="button"><i class="fa fa-download"></i></a> <a class="btn btn-default btn-outline export-invoice-print" role="button"><i class="fa fa-print"></i></a>
							</div>
						</div>
					</div>
					<table class="table display product-overview mb-30 dataTable nowrap" style="width: 100%" id="invoice-table" role="grid">
						<thead>
