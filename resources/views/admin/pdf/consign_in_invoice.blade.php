...
<html>
<head>
	<title>Consign IN Invoice {{ str_pad( $invoice->id, 4, "0", STR_PAD_LEFT ) }}</title>
	<!-- Custom CSS -->
	<style>
		.logo {
			max-width: 200px;
	...
	<div style="width: 100%" style="background: red">
		<div class="row">
			...
			<div class="col-md-12 text-right">
				...
				<h6 style="margin-top:25px">CI (IN) NO.: <span style="color: red; font-size: 20px !important; font-family: Arial !important"><strong>{{ str_pad( $invoice->id, 4, "0", STR_PAD_LEFT ) }}</strong></span></h6>
			</div>
		</div>
