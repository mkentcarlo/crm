...
<head>
	...
	@font-face {
	font-family: "Trajan";
	/* src: url({{asset('dist/fonts/customfont/TrajanPro.ttf')}}); */
	}
		.logo {
			max-width: 200px;
		}
	...
	<div style="width: 100%" style="background: red">
		<div class="row" style="background: #000">
			...
			<div class="col-md-12 text-right">
				<h5 style="font-size:18px">CONSIGN IN INVOICE</h5>
		...
		<table  style="width: 100%;margin-top:25px" class="bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td class="noborder text-right">&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
			</tbody>
		</table>
		...
		<table>
			<tbody>
				...
				<br>
				<strong>Consignor Signature</strong></td>
				</tr>
			</tbody>	
		</table>
		<div class="row">
			<div class="col-md-12 text-center">
			<p style="font-size:15px;font-weight:bold; margin-top:55px">LUXE MONTRE PTE. LTD <br>
